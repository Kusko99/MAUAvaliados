      ...
      <main className="min-h-screen w-full relative">
        <SignedIn>
          ...
          <div className="relative w-full">
            <Image src={stray} className="w-full lg:h-[80vh] object-cover z-0" />{" "}
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col items-start justify-start mb-14 min-h-screen xl:-mt-20 lg:-mt-20 md:-mt-20 sm:-mt-20">
              <h1 className="md:text-3xl text-2xl font-bold pb-4 mx-5 md:mx-12 z-20">
                Lançamentos
              </h1>
              <Carrossel />
              <h1 className="md:text-3xl text-2xl font-bold pb-4 mx-5 md:mx-12 mt-12">
                Em alta
              </h1>
              <Carrossel />
            </div>
